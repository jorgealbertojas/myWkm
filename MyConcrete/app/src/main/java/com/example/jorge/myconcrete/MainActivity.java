        ...
        public void onResponse(Call<ListWrapper<Repositories>> call, Response<ListWrapper<Repositories>> response) {
            try {
                if (response.isSuccessful()) {
                    ...
                    mDataBase.insertRepositories(data);

                    List<Repositories> dataPersistent = new ArrayList<>();
                    dataPersistent = mDataBase.getListRepositories();

                    mRepositoriesAdapter = new RepositoriesAdapter(dataPersistent);
                    mRecyclerView.setAdapter(mRepositoriesAdapter);
